...
\begin{singlespace}
  \begin{tabular}{ |p{3cm}|||p{4cm}|p{2cm}|p{2cm}|p{2cm}|  }
      ...
      & \cellcolor{orange} Exercises &\cellcolor{orange}  7 \textcolor{red}{NEW} & \cellcolor{orange}  60 &\cellcolor{orange}  ... \\
      \hline
      Vectors & Problems/Other & 12 & ... & ... \\
      & Exercises & 15 & ... & ... \\
      \hline
      Matrcies & \cellcolor{orange} Problems/Other &\cellcolor{orange}  18 &\cellcolor{orange}  40 & \cellcolor{orange} ... \\
      & \cellcolor{orange} Exercises &\cellcolor{orange}  28 &\cellcolor{orange}  35 &\cellcolor{orange}  ... \\
      \hline
      Fourier Series & Problems/Other & 37 & ... & ... \\
      & Exercises & 39 & 20 & ... \\
      \hline
      First-order Ordinary Diff. eg.  &\cellcolor{orange} Problems/Other &\cellcolor{orange} 46 &\cellcolor{orange} 40 &\cellcolor{orange} ... \\
      & \cellcolor{orange} Exercises &\cellcolor{orange}  53 &\cellcolor{orange}  ... &\cellcolor{orange}  ... \\
      \hline
      Second-order Ordinary Diff. eg. & Problems/Other & 55  & ... & ... \\
      & Exercises (Higher order) & 59 \textcolor{red}{NEW} & 95 & ... \\
      \hline
      Other Ordinary Diff. eg. and important Diff eg. &\cellcolor{orange} Problems/Other &\cellcolor{orange} 76 & \cellcolor{orange}... & \cellcolor{orange}...  \\ 
  ...
  \begin{enumerate}
    ...
    \begin{enumerate}
      \item $y^{\prime}+3y=e^{2x}$
        ...
        \textcolor{hwColor}{ 
          $
            \mu(x)=e^{\bigints 3 dx}=e^{3x} \\
          $
          Now multiple both sides by $\mu(x)$ \\
          $
            e^{3x}\dfrac{dy}{dx}+3e^{3x}y=e^{3x}e^{2x} \\
            \\
            e^{3x}\dfrac{dy}{dx}+3e^{3x}y=e^{5x} \\
            \\
            \dfrac{d}{dx}(e^{3x}y)=e^{5x} \\
            \\
            \bigints \dfrac{d}{dx}(e^{3x}y) dx=\bigints e^{5x} dx \\
            \\
            e^{3x}y=\dfrac{e^{5x}}{5}+c \\
            \\
            \Longrightarrow y(x)=e^{-3x}(\dfrac{e^{5x}}{5}+c)
          $
        }
      ...
      \item $y^{\prime}+3y=e^{3x}$
        ...
        \textcolor{hwColor}{ 
          ...
          $
            e^{3x}\dfrac{dy}{dx}+3e^{3x}y=e^{3x}e^{2x} \\
            \\
            e^{3x}\dfrac{dy}{dx}+3e^{3x}y=e^{6x} \\
            \\
            \dfrac{d}{dx}(e^{3x}y)=e^{6x} \\
            \\
            \bigints \dfrac{d}{dx}(e^{3x}y) dx=\bigints e^{6x} dx \\
            \\
            e^{3x}y=\dfrac{e^{6x}}{6}+c \\
            \\
            \Longrightarrow y(x)=e^{-3x}(\dfrac{e^{6x}}{6}+c)
          $
        }
      ...
      \item $y^{\prime}+3y=e^{-3x}$
        ...
        \textcolor{hwColor}{ 
          ...
          Now multiple both sides by $\mu(x)$ \\
          $
            e^{3x}\dfrac{dy}{dx}+3e^{3x}y=1 \\
            \\
            \bigints \dfrac{d}{dx}(e^{3x}y) dx=\bigints  dx \\
            \\
            e^{3x}y=x+c \\
            \\
            \Longrightarrow y(x)=e^{-3x}(x+c)
          $
        }
